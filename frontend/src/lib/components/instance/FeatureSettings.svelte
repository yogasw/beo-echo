...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h3 class="text-lg font-semibold theme-text-primary">Feature Configuration</h3>
    ...
    <div class="p-4 theme-bg-secondary rounded-lg border theme-border">
        <p class="theme-text-secondary text-sm mb-4">
            Enable or disable specific features across the application. Changes will take effect immediately for all users.
        </p>
        ...
        <div class="space-y-4">
            ...
            <!-- Additional feature toggles can be added here as needed -->
        </div>
    </div>
