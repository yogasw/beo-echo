...
<div class="space-y-4 p-4 theme-bg-secondary rounded-lg border theme-border">
	<!-- Target Selection -->
	<div>
		...
		<select
			id="target"
			bind:value={target}
			class="block w-full p-3 text-sm rounded-lg bg-gray-800 border theme-border theme-text-primary focus:ring-blue-500 focus:border-blue-500"
			required
			aria-required="true"
	...
	{#if showHeaderKey}
		<div>
			...
			<input
				...
				class="block w-full p-3 text-sm rounded-lg bg-gray-800 border theme-border theme-text-primary focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
	...
	<div>
		...
		<input
			...
			type="text"
			bind:value={pattern}
			class="block w-full p-3 text-sm rounded-lg bg-gray-800 border theme-border theme-text-primary focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 font-mono"
