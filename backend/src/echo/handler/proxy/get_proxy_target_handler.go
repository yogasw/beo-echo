...
//
// Sample curl:
// curl -X GET "http://localhost:8000/api/workspaces/{workspaceID}/projects/{projectId}/proxies/{proxyId}" -H "Content-Type: application/json" -H "Authorization: Bearer {token}"
